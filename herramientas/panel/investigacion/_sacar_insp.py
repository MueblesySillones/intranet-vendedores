...
salida = os.path.join(os.path.dirname(os.path.abspath(__file__)), "inspector_propuestas.md")
buf = []
for linea in io.open(J, encoding="utf-8"):
    ...
    if not isinstance(r, dict):
        continue
    z = str(r.get("zona", "")) + str(r.get("diagnostico", ""))[:200]
    if "inspector" not in z.lower():
        continue
...
print("BLOQUE_AYUDA:", "BLOQUE_AYUDA" in txt)
