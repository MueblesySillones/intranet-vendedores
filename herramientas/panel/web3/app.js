...
function kitVisorHTML(kit, fecha) {
  ...
  return [
    ...
    'details{border:1px solid #E4DFD6;border-radius:12px;margin:10px 0;background:#FCFBF9}',
    'details[open]{background:#fff}',
    'summary{cursor:pointer;padding:13px 16px;font-size:15px;font-weight:600;color:#2C2A26;',
    ...
    '/* cada seccion es un desplegable nativo: sin JS extra y funciona siempre */',
    'function sec(t,abierta){var d=document.createElement("details");if(abierta)d.open=true;',
    ' var s=document.createElement("summary");s.textContent=t;d.appendChild(s);return d;}',
    'function pintar(K){',
    ...
    ' if(K.clave_publicacion){var CP=K.clave_publicacion,d1=sec("🔑 La clave de publicación",true);',
    ...
    '   kb.appendChild(kv);d1.appendChild(kb);}',
    ...
    '  d1.appendChild(cp);c.appendChild(d1);}',
    ' if(K.mcp){var M=K.mcp;',
    '  var d2=sec("👤 Cómo le doy acceso a un desarrollador",true);',
    '  var ol2=document.createElement("ol");',
    '  M.pasos.forEach(function(p){var li=document.createElement("li");li.textContent=p;ol2.appendChild(li);});',
    '  d2.appendChild(ol2);c.appendChild(d2);',
    '  var d3=sec("🔓 Qué puede tocar con cada acceso",false);',
    '  M.alcance.forEach(function(a){var x=document.createElement("div");x.className="serv";',
    '   var t=document.createElement("h3");t.textContent=a.pieza+" — "+a.por_donde;x.appendChild(t);',
    '   var e=document.createElement("p");e.textContent=a.permite;x.appendChild(e);d3.appendChild(x);});',
    '  c.appendChild(d3);',
    '  var d4=sec("⚙️ La configuración que tiene que crear",false);',
    '  var rt=document.createElement("div");rt.className="ruta";rt.textContent=M.archivo;d4.appendChild(rt);',
    '  var pre=document.createElement("pre");pre.textContent=M.contenido;d4.appendChild(pre);',
    ...
    '  d4.appendChild(u2);c.appendChild(d4);}',
    ' var d5=sec("🏦 Las cuentas del sistema",false);',
    ...
    '  d5.appendChild(x);});',
    ' c.appendChild(d5);',
    ' var d6=sec("🆘 Si se pierde esta computadora",false);',
    ...
    ' d6.appendChild(ol);c.appendChild(d6);',
